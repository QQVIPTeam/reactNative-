...
//  RCTRootView *rootView = [self getRootViewModuleName:@"hotUpdate" launchOptions:launchOptions];
//  
...
//  self.window.rootViewController = rootViewController;
  ...
  self.rootView = [self getRootViewModuleName:@"hotUpdate" launchOptions:launchOptions];
...
- (void)applicationDidEnterBackground:(UIApplication *)application{
  ...
  self.rootView = [self getRootViewModuleName:@"hotUpdate" launchOptions:nil];
  self.rootView.backgroundColor = [[UIColor alloc] initWithRed:1.0f green:1.0f blue:1.0f alpha:1];
  self.rootViewController.view = self.rootView;
